...
wdOutput <- c("E:/microbiome/03.taxonomy")
...
tax_phylum<- read.table("24Sample_PhylumPercent_filtered1_m.txt",header=T,row.names = 1,na.strings = c("NA"))
...
(stackplot=tax_stackplot(tax_phylum, SampleData, groupID="group", topN=11, style="group")+
    scale_fill_manual(values=c("#d6d6ce","#8a8b79","#b1746f","#d49464","#5B8FA8","#888e4a","#ffb547","#8491b4","#f39b7f","#adb17d","#7e6148"))+
    mytheme1 )
zoom=1.5
stackplot
setwd(wdOutput)
